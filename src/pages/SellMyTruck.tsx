...
export default function SellMyTruck() {
  const [active] = useState<string>("truck");
                ...
                <div className="mx-auto max-w-[640px] text-center md:mx-0 md:text-left">
                  ...
                  <div className="relative mx-auto w-full max-w-[560px] md:mx-0">
                    <div className="relative mx-auto overflow-hidden rounded-[28px] bg-white/0 p-0 md:mx-0">
                      <img
                        src={heroTruck}
                        alt="Sell my truck hero"
                        className="mx-auto h-[210px] w-full max-w-[560px] rounded-[28px] object-contain md:mx-0"
                        loading="eager"
                    ...
                    {[
                      {
                        ...
                        desc: "Fill out the form with your truck details and we will provide an estimate price.",
                      },
                      {
                        n: 2,
                        title: "Convenient inspection",
                        desc: "We come to a location of your choice to inspect the truck.",
                      },
                      {
                        n: 3,
