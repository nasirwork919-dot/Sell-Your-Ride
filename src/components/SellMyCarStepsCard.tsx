...
const STEPS: Step[] = [
  {
    ...
    desc: "Find your car make, model, year and badge in the form above.",
    icon: ListChecks,
  },
  {
...
export function SellMyCarStepsCard({ className }: { className?: string }) {
  return (
    <section className={cn("w-full bg-[#F3F6FA]", className)} aria-label="How it works steps">
