    ...
    <section className={cn("w-full bg-[#F3F6FA]", className)} aria-label="Sell my car headline">
      <div className="mx-auto max-w-6xl px-4 py-12 sm:py-14 md:px-6">
        <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
          {/* Wordmark */}
          <div className="select-none text-[40px] font-extrabold leading-none tracking-tight text-[#0B3A7A] sm:text-[46px]">
            <span>Car</span>
            <span className="text-[#22B9C5]">Buyers</span>
            <span className="ml-1 align-top text-[10px] font-extrabold text-[#22B9C5] sm:text-[11px]">.com.au</span>
          </div>
